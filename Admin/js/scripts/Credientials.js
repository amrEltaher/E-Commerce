...
import { Admin, User } from "../../Modal.js";
...
const initUserManagement = ()=> {
  ...
  //comment this
  // let admin = new User("customer", "Ebrhim Dawoud", "customer@example.com", "123456", "1998").getUserProperties();
...
function ensureAdminUserExists(userArray, currentUser) {
  ...
  if (!isAdminExist(userArray)) {
    ...
    console.log(admin.getAdminProperties())
